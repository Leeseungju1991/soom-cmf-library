...
export default function ContactUs2({navigation}) {
  ...
  return (
    <View style={{flex: 1, marginTop : 40}}>
      ...
      <TouchableOpacity onPress={()=>navigation.goBack()} >
          <Icon style={{ marginLeft : 20, color : '#484848', fontFamily: "Pretendard", fontWeight: "500", fontSize : 17, fontStyle: "normal",  textAlign: "left",}} name="chevron-left" size={20} />
      </TouchableOpacity>
      <Text style={{ fontSize: 18 , marginRight : 'auto', marginLeft :10 }}>{"비밀번호 변경"}</Text>
      </View>
      <View style={{ borderBottomColor: '#484848', borderBottomWidth: 0.7, marginTop : 20}}/>
      <ScrollView showsVerticalScrollIndicator={false}>
      <TouchableOpacity activeOpacity={0.11} onPress={()=>navigation.navigate("ContactUs2")}>
      ...
      <Icon name="chevron-right" size={20} color ='#dedede' style={{marginLeft: 'auto', marginRight: 35, marginTop : -20}} /> 
